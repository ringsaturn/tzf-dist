...
**Version:** 2026c
**Build date:** 2026-07-12T04:17:36Z

## Output Files

| File | Size | MD5 |
|------|------|-----|
| `combined-with-oceans.compress.topo.bin` | 18.0 MB | `5b5b7bddbbb4f4cdfb7e3ee820d86fb4` |
| `combined-with-oceans.topology.compress.topo.bin` | 6.5 MB | `b4215ef1e7bbe36110524c7bcc76d57d` |
| `combined-with-oceans.topology.preindex.bin` | 1.9 MB | `027305ca7f23ae5f1878b93da6a55a42` |
...
dataset_after:  timezones=444 polygons=1322 holes=756 points=1117128 bytes=13420784
...
```
input:  timezones=444 polygons=1322 holes=756 points=1117128 bytes=13420791
output: shared_edges=2907 shared_points=467905 inline_segs=183838 edge_ref_segs=5592 bytes=10959058
...
```
input:  bytes=10959058
output: bytes=6858077
...
```
input:  timezones=444 bytes=13420791
